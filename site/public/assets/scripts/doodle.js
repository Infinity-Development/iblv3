...
function init() {
  ...
  function gameOver() {
    ...
    if (player.y > height / 2 && flag === 0) {
      ...
      tweet.href =
        'https://twitter.com/share?url=http://is.gd/PnFFzu&text=I just scored ' +
        score +
      ...
      facebook.href =
        'https://facebook.com/sharer.php?s=100&p[url]=http://cssdeck.com/labs/html5-doodle-jump/8&p[title]=I just scored ' +
        score +
...
document.getElementById('DoodleBtn').onclick = function () {
  document.getElementById('Doodle_window').style.display = 'block';
};

document.getElementsByClassName('close')[0].onclick = function () {
  document.getElementById('Doodle_window').style.display = 'none';
};
window.onclick = function (event) {
  if (event.target == document.getElementById('Doodle_window')) {
    document.getElementById('Doodle_window').style.display = 'none';
  }
};
