$(function () {
  $('#pieChart').drawPieChart([
    {
      title: 'Views',
      value: Math.abs(document.getElementById('clicks').innerHTML),
      color: '#3367D6',
    },
    {
      title: 'Unique Views',
      value: Math.abs(document.getElementById('unique_clicks').innerHTML),
      color: '#7BAAF7',
    },
    {
      title: 'Invites',
      value: Math.abs(document.getElementById('invites').innerHTML),
      color: '#5892f5',
    },
    {
      title: 'Votes',
      value: Math.abs(document.getElementById('votes').innerHTML),
      color: '#6592df',
    },
  ]);
});
